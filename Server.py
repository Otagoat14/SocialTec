...
def manejar_cliente(cliente, addr):
    ...
    if mensajes[0] == "login":
        ...
        resultado = cliente_login.login(mensajes[1], mensajes[2])
    ...
    elif mensajes[0] == "registro":
        cliente_registro = ManejoUsuarios()
        
        exito = cliente_registro.registrar_usuario(mensajes[1], mensajes[2], mensajes[3], mensajes[4])
    ...
    elif mensajes[0] == "buscar":
        cliente_buscar = BaseDeDatos()
        hola = cliente_buscar.buscar_usuarios(mensajes[1])
        print(hola)
